...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (":host(app-nav) {\n  padding-top: 0;\n  padding-bottom: 6.5rem;\n  display: grid;\n}\n:host(app-nav) header {\n  position: fixed;\n  z-index: 999;\n  width: 100%;\n}\n:host(app-nav) header nav {\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-wrap: wrap;\n      flex-wrap: wrap;\n  -ms-flex-align: center;\n      align-items: center;\n  padding: 0.5rem 1rem;\n  color: #ffffff;\n  height: 4rem;\n  background: #3f51b5;\n}\n:host(app-nav) header nav .mat-raised-button {\n  color: #3f51b5;\n  margin-right: 1rem;\n}\n:host(app-nav) header nav .progress-bar {\n  display: -ms-flexbox;\n  display: flex;\n  -ms-flex-line-pack: center;\n      align-content: center;\n  -ms-flex-align: center;\n      align-items: center;\n  height: 0.3125rem;\n}\n:host(app-nav) header nav .icon__image {\n  width: 1.25rem;\n  height: 1.25rem;\n}\n:host(app-nav) header nav img {\n  vertical-align: middle;\n}\n:host(app-nav) header nav #today {\n  font-size: 0.7rem;\n}\n@media (max-width: 807px) {\n  #today {\n    width: 50%;\n  }\n}\n@media (max-width: 680px) {\n  :host(app-nav) {\n    padding-top: 0;\n    padding-bottom: 1rem;\n  }\n  :host(app-nav) header {\n    position: relative;\n  }\n  :host(app-nav) header nav {\n    height: 7rem;\n    display: -ms-flexbox;\n    display: flex;\n    padding: 0.2rem 0.2rem 0;\n  }\n  :host(app-nav) header nav > div {\n    margin-top: 1rem;\n  }\n  :host(app-nav) header nav #today {\n    margin-top: 1rem;\n  }\n}\n@media (max-width: 425px) {\n  :host(app-nav) {\n    padding-bottom: 0;\n  }\n  :host(app-nav) header nav app-search-bar {\n    width: 75%;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var NavComponent = /** @class */ (function () {
    ...
    NavComponent.prototype.loadMenus = function () {
        ...
        var defaultMenuItems = [
            { link: '/' + _config_app_config__WEBPACK_IMPORTED_MODULE_2__["AppConfig"].routes.home, name: 'home' },
            { link: '/' + _config_app_config__WEBPACK_IMPORTED_MODULE_2__["AppConfig"].routes.wordlist, name: 'wordlist' },
            { link: '/' + _config_app_config__WEBPACK_IMPORTED_MODULE_2__["AppConfig"].routes.faq, name: 'faq' },
        ];
        this.translateService.get(['home', 'faq', 'wordlist'], {}).subscribe(function (texts) {
            _this.menuItems = [
                { link: '/' + _config_app_config__WEBPACK_IMPORTED_MODULE_2__["AppConfig"].routes.home, name: texts['home'] },
                { link: '/' + _config_app_config__WEBPACK_IMPORTED_MODULE_2__["AppConfig"].routes.wordlist, name: texts['wordlist'] },
                { link: '/' + _config_app_config__WEBPACK_IMPORTED_MODULE_2__["AppConfig"].routes.faq, name: texts['faq'] },
            ];
        }, function (error) {
            _this.menuItems = defaultMenuItems;
        }, function () {
